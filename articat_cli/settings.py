...
SERVERS = MappingProxyType(
    {
        ...
        Server.HELIX_DEV.value: {
            "hostname": "https://srp-platform.srp-dev.esp.vmware.com",
            "ssl_verify": True,
            "is_within_envoy": True,
            "csp_token_url": CSP_STG_TOKEN_URL,
        },
        Server.HELIX_STAGING.value: {
            "hostname": "https://srp-platform.srp-staging.esp.vmware.com",
            "ssl_verify": True,
            "is_within_envoy": True,
            "csp_token_url": CSP_STG_TOKEN_URL,
        },
        Server.HELIX_PRODUCTION.value: {
            "hostname": "https://srp-platform.srp.esp.vmware.com",
            "ssl_verify": True,
            "is_within_envoy": True,
